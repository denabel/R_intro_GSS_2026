---
title: 'Exercise 2_2_3: Across/aggregate variables & conditional recoding'
...
*Note*: For these exercises, we need the same packages as for the previous ones in this session: `sjlabelled`, `tidyverse`, `haven` plus the `naniar` package.
...
Let's create an unordered factor based on the variable representing marital status (`mstat`). The factor levels should be the English translations of the first five value labels listed in the codebook: "Married and living with spouse", "Married and living separately", "Widowed", "Divorced", "Unmarried".
