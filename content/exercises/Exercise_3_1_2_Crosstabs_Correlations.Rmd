---
title: 'Exercise 3_1_2: Crosstabs & correlations'
...
As a first exercise, use the `janitor` package to create a crosstab for the variables `agec` (rows) and `party_vote` (columns) showing row percentages. 
```
...
Compute a chi-square test for the `tabyl` we have created before. 
```
