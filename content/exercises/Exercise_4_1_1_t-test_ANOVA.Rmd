...
allbus_2021_cda_1 <- read_spss("./data/allbus_2021/ZA5280_v2-0-1.sav")
```
...
anova <- aov(as.numeric(pa01) ~ as.factor(agec), data = allbus_2021_cda_1)
...
ancova <- 
  aov(as.numeric(pa01) ~ as.factor(agec) + as.factor(sex) + as.factor(eastwest), 
      data = allbus_2021_cda_1)
