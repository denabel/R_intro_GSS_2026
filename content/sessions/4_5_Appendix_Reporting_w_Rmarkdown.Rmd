...
knitr::include_graphics("https://raw.githubusercontent.com/rstudio/hex-stickers/main/thumbs/rmarkdown.png")
```
...
When you use `R Markdown` to create documents it makes sense to adopt a [project-based workflow using *RStudio* projects](https://rstats.wtf/projects) to "have everything in one place" which facilitates sharing and increases reproducibility (for yourself and others).
...
### Exercise_5_1_1_R_Markdown.html
