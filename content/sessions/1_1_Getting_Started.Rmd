...
.pull-left[
```{r jan-pic, echo = FALSE, out.width = "40%"}
woRkshoptools::include_picture("./Jan.jpg")
```
]

.pull-right[
-   **Postdoctoral Researcher** in the team Archiving at the GESIS department Data Services for the Social Sciences
-   Ph.D. in **Political Sciences, University of Cologne**
]
...
[jan.schwalbach@gesis.org](mailto:jan.schwalbach@gesis.org) |
[Personal GESIS website](https://www.gesis.org/institut/ueber-uns/mitarbeitendenverzeichnis/person/jan.schwalbach)
]
...
.pull-left[
```{r dennis-pic, echo = FALSE, out.width = "40%"}
woRkshoptools::include_picture("./Dennis.png")
```
]
