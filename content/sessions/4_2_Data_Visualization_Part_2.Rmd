...
### Exercise_4_2_1_Plotting_Diagnostics.html
...
### Exercise_4_2_2_Plotting_a_Regression.html
...
Things can get messy if we have to work with statistical models that are not incorporated into the presented packages. For example, when you want to make use of results produced with other statistical software like *Stata*. 
---
...
### Exercise_4_2_3_Combining_Predictions.html
